...
Adds a search box directly into the default Guild UI and filters the **native roster list** by **member name** (substring match), keeping the normal Guild UI features.
